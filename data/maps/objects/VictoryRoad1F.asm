...
VictoryRoad1F_Object:
	...
	def_object_events
	object_event  6,  6, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_VICTORYROAD1F_COOLTRAINER_F, OPP_COOLTRAINER_F, 5
	object_event  3,  2, SPRITE_COOLTRAINER_M, STAY, LEFT, TEXT_VICTORYROAD1F_COOLTRAINER_M, OPP_COOLTRAINER_M, 5
	object_event  7, 11, SPRITE_YOUNGSTER, STAY, DOWN, TEXT_VICTORYROAD1F_BUG_CATCHER, OPP_BUG_CATCHER, 16
	object_event 12, 12, SPRITE_BEAUTY, STAY, LEFT, TEXT_VICTORYROAD1F_BEAUTY, OPP_BEAUTY, 16
	object_event  8,  8, SPRITE_SUPER_NERD, STAY, LEFT, TEXT_VICTORYROAD1F_BURGLAR, OPP_BURGLAR, 10
	object_event  1,  5, SPRITE_HIKER, STAY, RIGHT, TEXT_VICTORYROAD1F_BLACKBELT, OPP_BLACKBELT, 9
