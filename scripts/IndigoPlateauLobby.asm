...
IndigoPlateauLobbyClerkText::
	script_mart  RARE_CANDY, HYPER_POTION, FULL_RESTORE, MAX_REVIVE, MAX_ELIXER, MAX_REPEL, TM_FLAMETHROWER, TM_ICE_BEAM, TM_SUBMISSION, TM_MEGA_DRAIN, TM_SOLARBEAM, TM_THUNDERBOLT, TM_DREAM_EATER, TM_ROCK_SLIDE
